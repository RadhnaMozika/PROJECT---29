...
function setup() {
    ...
    box18 = new Box(550, 300, 50, 50);
    box19 = new Box(600, 300, 50, 50);
    box20 = new Box(650, 300, 50, 50);
    box21 = new Box(700, 300, 50, 50);
 
    //flevel 4, structure 1
    box22 = new Box(550, 240, 50, 50);
    box23 = new Box(600, 240, 50, 50);
    box24 = new Box(650, 240, 50, 50);

    //level 5, structure 1
    box25 = new Box(600, 180, 50, 50);

    //level 1, structure 2
    box26 = new Box(975, 180, 50, 50);
    box27 = new Box(1025, 180, 50, 50);
    box28 = new Box(1075, 180, 50, 50);
    box29 = new Box(1125, 180, 50, 50);
    box30 = new Box(1175, 180, 50, 50);

    //level 2, structure 2
    box31 = new Box(1025, 140, 50, 50);
    box32 = new Box(1075, 140, 50, 50);
    box33 = new Box(1125, 140, 50, 50);

    //level 3, structure 2
    box34 = new Box(1075, 80, 50, 50);
...
function draw(){
    ...
    textSize(28);
    fill("#FFFFFF")
    text("DRAG  THE  HEXAGON  AND  RELEASE  IT", 50, 50);
